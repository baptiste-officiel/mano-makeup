        ...
        {modal && 
            <Modal>
                ...
                <input type="text" value={prestationToAdd.title} className='border-2 border-primary-color rounded-md w-full mx-auto px-2 py-1 placeholder:text-sm shadow-sm' placeholder='Titre' onChange={(e) => setPrestationToAdd({...prestationToAdd, title: e.target.value})} />
                    ...
                    <input type="text" value={prestationToAdd.image} className='border-2 border-primary-color rounded-md w-full mx-auto px-2 py-1 placeholder:text-sm shadow-sm' placeholder='Image' onChange={(e) => setPrestationToAdd({...prestationToAdd, image: e.target.value})} />
                    <input type="text" value={prestationToAdd.duration} className='border-2 border-primary-color rounded-md w-full mx-auto px-2 py-1 placeholder:text-sm shadow-sm' placeholder='Durée' onChange={(e) => setPrestationToAdd({...prestationToAdd, duration: e.target.value})} />
                    <input type="text" value={prestationToAdd.price} className='border-2 border-primary-color rounded-md w-full mx-auto px-2 py-1 placeholder:text-sm shadow-sm' placeholder='Prix' onChange={(e) => setPrestationToAdd({...prestationToAdd, price: e.target.value})} />
                    <input type="text" value={prestationToAdd.secondaryPrice} className='border-2 border-primary-color rounded-md w-full mx-auto px-2 py-1 placeholder:text-sm shadow-sm' placeholder='Prix secondaire' onChange={(e) => setPrestationToAdd({...prestationToAdd, secondaryPrice: e.target.value})} />
