...
function Footer() {
  return (
    <footer className='border-t-4 border-primary-color w-full pt-12 absolute bottom-0 mt-10'>
        ...
        <div className='relative w-full text-center text-sm bg-footer bg-cover bg-center mt-12 py-4 before:absolute before:bg-[rgb(0_0_0_/_20%)] before:w-full before:h-full before:top-0 before:left-0'>
          <p className='relative z-20 text-white text-stroke'>Réalisé avec 💜  par <a href="https://www.baptistelejeune.fr/" className='font-semibold'>Baptiste Lejeune</a> </p>
